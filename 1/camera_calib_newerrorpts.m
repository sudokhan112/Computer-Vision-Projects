...
A = [xw1 yw1 zw1 1 0 0 0 0 -x1*xw1 -x1*yw1 -x1*zw1;
 ...
 b = [x1;
  ...
  K = [alpha s u0;
   ...
   xw1_c=0; yw1_c=12;zw1_c=2;     x1_c=1235.2;y1_c=880.4;
   %point 2
   xw2_c=8; yw2_c=0;zw2_c=2;     x2_c=739.9;y2_c=881.9;
   
   %Points far (0,0,0)
   %point3
   xw3_c=0; yw3_c=16;zw3_c=8;     x3_c=1340.5;y3_c=654.4;
   %point4
   xw4_c=18; yw4_c=0;zw4_c=14;     x4_c=456.7;y4_c=433.1;
...
%disp(X6new)
error_norm = [norm1 norm2 norm3 norm4];
summary(error_norm)
